...
class ThreadedBroadcastClient:
    ...
    def __init__(self, host: str, port: int, header_size: int, buffer_size: int):
        """
    ...
    def _receive_packets_thread(self, output_queue: Queue, is_running: Event):
        """
    ...
    def recv_object_with_net_stats(self) -> (object, int, int):
        """
